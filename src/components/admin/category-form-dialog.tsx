      ...
      <DialogContent className='sm:max-w-[600px] max-h-[90vh] overflow-y-auto'>
        <DialogHeader className='pb-4'>
          ...
          <DialogDescription className='text-gray-600'>
            {isEditing ? 'Cập nhật thông tin danh mục dưới đây.' : 'Nhập thông tin chi tiết cho danh mục mới.'}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className='space-y-6'>
            <div className='grid grid-cols-1 gap-6'>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='text-gray-700 font-medium'>Tên Danh Mục *</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='text-gray-700 font-medium'>Hình Ảnh Danh Mục</FormLabel>
                    <FormControl>
                      <ImageUpload
                        value={field.value || []}
