...
import { ShoppingCart, Heart, Star, Facebook, Instagram, Twitter, Sparkles } from 'lucide-react'
...
const productGridItems = {
  ...
  sale: [
    {
      id: 10,
      name: 'Sale Maternity Living Dress',
      price: 69.99,
      originalPrice: 89.99,
            ...
            <div className='space-y-8'>
              <div className='space-y-4'>
                ...
                <p className='text-lg text-gray-600 max-w-md'>
                  Everyone deserves to feel fantastic during her pregnancy. Shop stylish options for every occasion,
                  whether you're going to work or staying home.
                </p>
              </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Hot off the press: these trendy maternity clothes are the very latest addition to our fashionable
              selection.
            </p>
          </div>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              ...
              <p className='text-gray-600 leading-relaxed'>
                Here at MamaFit, we specialize in innovative maternity & nursing designs that respond to your growing
                body and changing needs. We blend style, comfort, and functionality to create pieces you'll love wearing
            ...
            <div className='relative'>
              <div className='aspect-square bg-gradient-to-br from-violet-200 to-purple-300 rounded-2xl overflow-hidden'>
                <img src='/api/placeholder/500/500' alt='About MamaFit' className='w-full h-full object-cover' />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              ...
              <p className='text-lg text-white/90'>Treat yourself to a gorgeous new maternity dress</p>
              <CountdownTimer />
            ...
            <div className='relative'>
              <div className='aspect-square bg-white/10 backdrop-blur rounded-2xl overflow-hidden'>
                <img src='/api/placeholder/400/400' alt='Deal of the day' className='w-full h-full object-cover' />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='text-center mb-12'>
            ...
            <div className='max-w-3xl mx-auto'>
              <div className='bg-violet-50 rounded-2xl p-8 mb-8'>
                <p className='text-lg text-gray-700 italic mb-6'>"{testimonials[currentTestimonial].content}"</p>
