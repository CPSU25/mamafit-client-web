...
import { Package, User, CreditCard, Truck, Calendar, ExternalLink, Mail, Phone } from 'lucide-react'
import { format } from 'date-fns'
import { useNavigate } from 'react-router-dom'
import { useGetUserById } from '@/services/admin/manage-user.service'

interface BranchOrderDetailDialogProps {
  order: BranchOrderType | null
  isOpen: boolean
  onClose: () => void
}

export function BranchOrderDetailDialog({ order, isOpen, onClose }: BranchOrderDetailDialogProps) {
      ...
      <DialogContent className='max-w-2xl max-h-[90vh] overflow-y-auto'>
        <DialogHeader>
          <div className='flex items-center gap-2'>
            ...
            <DialogTitle className='text-lg font-semibold'>Chi tiết đơn hàng</DialogTitle>
          </div>
        </DialogHeader>
