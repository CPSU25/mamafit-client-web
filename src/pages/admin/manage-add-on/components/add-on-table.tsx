...
import { AddOnTableToolbar } from './add-on-table-toolbar'
import { ExpandedAddOnOptions } from './expanded-add-on-options'
import { addOnColumns } from './add-on-columns'
...
export function AddOnTable({ data }: AddOnTableProps) {
  ...
  const expandableColumns: ColumnDef<AddOn>[] = [
    // Expand column
    {
      id: 'expand',
      header: () => null,
                    ...
                    <TableRow>
                      <TableCell colSpan={expandableColumns.length} className='p-0'>
                        <div className='border-l-4 border-primary'>
                          <ExpandedAddOnOptions addOn={row.original} />
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
