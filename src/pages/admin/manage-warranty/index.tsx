      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='mb-8'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-gray-600 mt-2'>Xử lý và theo dõi các yêu cầu bảo hành từ khách hàng</p>
            </div>
        ...
        {filteredRequests.length === 0 && (
          <div className='text-center py-12'>
            ...
            <h3 className='text-lg font-medium text-gray-900 mb-2'>Không có yêu cầu bảo hành nào</h3>
