...
interface ComponentsTableProps {
  columns: ColumnDef<Component>[]
  data: Component[]
}

export function ComponentsTable({ columns, data }: ComponentsTableProps) {
  ...
  const expandableColumns: ColumnDef<Component>[] = [
    // Expand column
    {
      id: 'expand',
      header: () => null,
  ...
  return (
    <div className='space-y-4'>
      {/* Search Filter */}
      <ComponentTableToolbar<Component> table={table} />
                    ...
                    <TableRow>
                      <TableCell colSpan={expandableColumns.length} className='p-0'>
                        <div className='border-l-4 border-primary'>
                          <ExpandedComponentDetail componentId={row.original.id} />
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
