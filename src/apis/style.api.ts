...
export const styleAPI = {
  ...
  getStyleById: (id: string) => 
    api.get<ItemBaseResponse<StyleType>>(`/style/${id}`),

  // Create new style
  createStyle: (data: StyleFormData) =>
    api.post<ItemBaseResponse<StyleType>>('/style', data),

  // Update style
  updateStyle: (id: string, data: StyleFormData) =>
    api.put<ItemBaseResponse<StyleType>>(`/style/${id}`, data),

  // Delete style
  deleteStyle: (id: string) =>
    api.delete<ItemBaseResponse<StyleType>>(`/style/${id}`),
} 